        ...
        <div className={`min-h-screen ${isDark ? 'bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a]' : 'bg-gradient-to-br from-[#f8fafc] via-[#e2e8f0] to-[#f8fafc]'}`}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-12">
                <div className="text-center mb-16 sm:mb-20">
                    <div className={`inline-flex items-center gap-2 ${isDark ? 'bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-500/20' : 'bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200'} border rounded-full px-4 py-2 mb-6`}>
                        <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                        <span className={`${isDark ? 'text-purple-300' : 'text-purple-600'} text-sm font-medium`}>Simple Process</span>
                    </div>
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className={`flex-1 ${index % 2 === 0 ? 'sm:text-right' : 'sm:text-left'}`}>
                                <div className={`${isDark ? 'bg-gray-800/30 border-gray-700/50' : 'bg-white/60 border-gray-200 shadow-sm'} backdrop-blur-sm border rounded-2xl p-6 sm:p-8 ${index % 2 === 0 ? 'sm:mr-8' : 'sm:ml-8'
                                    }`}>
                            ...
                            {/* Center dot */}
                            <div className={`hidden sm:flex absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 border-4 ${isDark ? 'border-[#0f172a]' : 'border-[#f0f4f8]'}`}></div>
                ...
                <div className="mt-20 sm:mt-28">
                    <div className="text-center mb-12">
                        ...
                        <p className={`${isDark ? 'text-gray-400' : 'text-gray-500'} text-lg max-w-xl mx-auto`}>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                        {technologies.map((tech, index) => (
                            <div
                                key={index}
                                className={`${isDark ? 'bg-gray-800/30 border-gray-700/50 hover:border-gray-600/50' : 'bg-white/60 border-gray-200 hover:border-gray-300 shadow-sm'} backdrop-blur-sm border rounded-xl p-4 text-center transition-all hover:transform hover:-translate-y-1`}
                            >
                                <div className="text-3xl mb-2">{tech.icon}</div>
                                <div className={`${isDark ? 'text-white' : 'text-gray-900'} font-semibold text-sm`}>{tech.name}</div>
                                <div className={`${isDark ? 'text-gray-500' : 'text-gray-400'} text-xs`}>{tech.description}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="mt-20 sm:mt-28 text-center">
                    <div className={`${isDark ? 'bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-orange-500/10 border-gray-700/50' : 'bg-gradient-to-r from-purple-50 via-pink-50 to-orange-50 border-gray-200'} border rounded-3xl p-8 sm:p-12 lg:p-16`}>
                        <h2 className={`text-3xl sm:text-4xl font-bold ${isDark ? 'text-white' : 'text-gray-900'} mb-4`}>
                            Ready to Try It?
                        </h2>
