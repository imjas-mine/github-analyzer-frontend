function RepositoryCard({ repo, username, formatDate, onClick, isSelected }) {
  return (
    <div 
      onClick={onClick}
      className={`bg-gray-800/50 hover:bg-gray-800/70 border rounded-2xl p-6 transition-all cursor-pointer ${
        isSelected 
    ...
    >
      ...
      <p className="text-gray-400 mb-4 line-clamp-2">{repo.description || 'No description provided.'}</p>
