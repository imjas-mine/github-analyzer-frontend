  ...
  return (
    <div className="fixed inset-0 lg:inset-auto lg:top-[88px] lg:right-0 lg:bottom-0 w-full lg:w-[550px] xl:w-[700px] bg-gradient-to-b from-gray-900 via-gray-900 to-[#0f172a] border-l border-gray-700/50 z-40 flex flex-col">
      ...
      <div className="flex-shrink-0 bg-gradient-to-r from-gray-900 via-gray-800/80 to-gray-900 border-b border-gray-700/50 p-4 sm:p-5 lg:p-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 bg-yellow-500/10 border border-yellow-500/20 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full">
            ...
            <span className="text-gray-500 text-xs sm:text-sm hidden sm:inline">stars</span>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 bg-blue-500/10 border border-blue-500/20 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full">
            ...
            <span className="text-gray-500 text-xs sm:text-sm hidden sm:inline">forks</span>
          </div>

          {/* Primary Language */}
          {repo.primaryLanguage && (
            <div className="flex items-center gap-1.5 sm:gap-2 bg-gray-700/30 border border-gray-600/30 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full">
              <div 
                className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full" 
                style={{ backgroundColor: repo.primaryLanguage.color || '#888' }}
              ></div>
              <span className="text-gray-300 font-medium text-sm sm:text-base">{repo.primaryLanguage.name}</span>
            </div>
          )}
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-5 lg:p-6 space-y-4 sm:space-y-5 lg:space-y-6 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
        {/* Description Card */}
        <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-gray-700/30">
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-800/50 hover:bg-gray-700/50 border border-gray-700/50 rounded-lg sm:rounded-xl text-white text-sm sm:text-base font-medium transition-all hover:scale-[1.02]"
          >
          ...
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-800/50 border border-gray-700/50 rounded-lg sm:rounded-xl text-gray-400">
        ...
        <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-gray-700/30">
          ...
          {loadingAnalysis ? (
            ...
            <p className="text-gray-300 leading-relaxed text-sm sm:text-base">{analysis.description}</p>
          ) : (
        ...
        {isMultiContributorRepo && (
          <div className="bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-indigo-500/30">
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3 sm:mb-4 flex items-center gap-2">
          ...
          {loadingDetails ? (
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">Loading README...</span>
              </div>
              <div className="space-y-2">
                <div className="h-4 bg-gray-700/50 rounded-lg animate-pulse w-full"></div>
            ...
            <div className="bg-gray-900/50 rounded-lg sm:rounded-xl p-3 sm:p-4 max-h-60 sm:max-h-80 overflow-y-auto">
              <pre className="text-gray-300 text-xs sm:text-sm whitespace-pre-wrap font-mono leading-relaxed">
